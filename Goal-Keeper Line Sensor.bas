...
let b10=152  'AFINAÇÂO para anular as reflexões nos cantos  (nº maior aumenta sensibilidade)  
...
frente11:
if b0<134 then xuto     'NO Nº2 Valor 131
if b0>133 and b0<b16 then frente

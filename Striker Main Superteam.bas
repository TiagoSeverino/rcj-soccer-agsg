...
frente:
if w1>28 and w1<20 then posicionase   '200  120    '????????????????????????????????????????????????????
...
pwmout portc 1, 10, 32'37  '32  
pwmout portc 2, 10, 32'37  '32
goto inicio
...
pwmout portc 1, 10,28'32'30'28'26'40'motores do lado direito   xxxxxxxxxxxxxxx   AFINAÇÃO VELOCIDADE
pwmout portc 2, 10,28'32'30'32'29'50'motores do lado esquerdo           (para velocidade maior tem de ser
...
high 3
low 4' desliga o dribulador
pwmout portc 1, 10,20'24'26'40motores do lado direito
pwmout portc 2, 10,20'24'26'50'motores do lado esquerdo        
goto inicio
...
'#######################################################################
'################alterado para campo de super teams#####################
frente_bola_baliza:
low 6
PULSOUT 6, 5   
...
PULSOUT 5, 5   
PULSIN 0, 1, w6
if w4<1001 and w6>1000 then obl_dir_suave'direita_obliq'antigamente 250
if w4>1000 and w6<1001 then obl_esq_suave'esquerda_obliq
if w4>1000 and w6>1000 then frente_bola_baliza_frente
if w4<1001 and w6<1001 then frente_bola_baliza_frente'
goto inicio
...
PULSOUT 6, 5   'Ultra Sons e escreve na w4-lado esquerdo
PULSIN 1, 1, w4                                                 
if W4<550 and W6<550 then frente300  
if W4>550 and W6>550 then inicio
if W4>550 and W6<551 then frente_oblq_esqerda_x 
if W4<551 and W6>550 then frente_oblq_direita_x
goto inicio
